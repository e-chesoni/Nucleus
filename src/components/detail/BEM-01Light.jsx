...
Command: npx gltfjsx@6.2.10 BEM-01_Light.glb 
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/BEM-01Light.glb')
  return (
    <group {...props} dispose={null}>
      <group rotation={[0.75, -0.4, 0]} scale={0.017}>
        <mesh geometry={nodes.BEM01_v17_1.geometry} material={materials['Glass_-_Heavy_Color_(Blue)']} />
...
useGLTF.preload('/BEM-01Light.glb')
